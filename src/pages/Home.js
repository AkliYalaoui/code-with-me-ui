...
const Home = () => {
  ...
  return (
    <header className="mt-6 max-w-5xl m-auto">
      <h1 className="text-2xl sm:text-5xl font-medium" style={{lineHeight:"4rem"}}>You Want Test Some Html Css Or Js, Or Look At Some Code ?</h1>
      <p className="mt-6 mb-8 opacity-90 text-2xl leading-10">You Are In The Right Place, Even Better You Can Do It Real Time With Friends. CodeWithMe Let You Achieve All Of That And More.</p>
      ...
      <section className="mt-14 flex justify-between items-center">
        <article className="bg-gray-900 p-4 max-w-xs rounded h-44 flex-1">
