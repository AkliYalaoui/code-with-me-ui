...
import { Home, Login, Register, Dashboard,AddProject,Project } from "./pages";
    ...
    <Router>
      ...
      <div className="max-w-7xl m-auto p-4 my-10">
        <Routes>
          ...
          {user ? (<Route path="/project/:id" element={<Project />} />) : (<Route path="/project/:id" element={<Navigate to="/login" />} />)}
          {user ? (<Route path="/add-project" element={<AddProject />} />) : (<Route path="/add-project" element={<Navigate to="/login" />} />)}
